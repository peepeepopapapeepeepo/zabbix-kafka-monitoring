...
1. Import template ([zbx_kafka_templates.xml](/kafka-server/zbx_kafka_templates.xml), [zbx_templates_kafkaconsumers.xml](/kafka-consumer/zbx_templates_kafkaconsumers.xml))
